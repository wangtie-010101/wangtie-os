...
var mountState = { apiError: "", staticError: "", apiDetail: "", staticDetail: "" };
function noteMountError(section, message, detail = "") {
  if (section === "api") {
    mountState.apiError = message;
    mountState.apiDetail = detail;
  } else {
    mountState.staticError = message;
    mountState.staticDetail = detail;
  }
}
